...
CUDA_VISIBLE_DEVICES=2 python dihcl.py -d cifar10 -a wrn --epochs 300 --wd 1e-4 --k 1.0 --dk 0.1 --mk 0.3 --use_curriculum --bandits_alg 'EXP3' --use_mean_teacher --gpu-id '2' --data_path ../data --save_path checkpoints/cifar10/AdaAug1 --trialID 'dihcl_exp_dloss_wrn2810/'
